...
def minibatch_parse(sentences, model, batch_size):
	...
	while len(sentences) != 0:
		sentences_to_parse = sentences if len(sentences) < batch_size else sentences[:batch_size]
		sentences = [] if len(sentences) < batch_size else sentences[batch_size:]
		unfinished_parses = partial_parses = [PartialParse(sentence) for sentence in sentences_to_parse]
